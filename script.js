...
const text = `Dear Larah, 
      ...
      In this lovely day of hearts, I want you to know that you are someone special and dear to me. We may be just starting now, but do know, in this sworn testimony of mine, that I will be here right by your side, ready when you call me, ready when you need me, and ready when you need someone to talk to every step of the way. I will be waiting for you, I will be standing right by your side while we achieve our dreams and turn them into reality. May we be blessed life, and let us celebrate this Valentine's day full of love and happiness. 
...
let i = 0;
const typingSpeed = 130;      // VERY slow intimate typing
const soundSpeed = 250;       // slower typing click pacing
...
landing.addEventListener("click", () => {
  ...
  // Song starts immediately with typing
  bgm.currentTime = 0;
  bgm.play().catch(() => {});
